 ...
 <head>
  ...
  <body>
    ...
    <section class="contact_area section_gap" style="padding: 6% 0 10% 0;">
		<div class="container">
			<form class="needs-validation" method="post" action="updateQna" onsubmit="submitContents()" id="updateForm">
				<input type="hidden" name="qnaNo" value="${vo.qnaNo}">
				<div class="form-row">
					<div class="col-md-4 mb-3">
						<label for="validationCustom01">제목</label>
						<input type="text" class="form-control" name="qnaTitle" placeholder="제목을 입력하세요" value="${vo.qnaTitle}" required>             
					</div>
				</div>    
				<div class="mb-10">
					<label for="validationTextarea">내용</label>
					<textarea cols="15" rows="15" class="form-control" name="qnaContent" id="ir1"
						style="resize: none; margin: 0 0 2% 0 ;" placeholder="내용을 입력하세요" required>${vo.qnaContent}</textarea>
            	</div>
				...
				<input type="submit" class="btn primary-btn" id="submitBtn" style="float:right;" value="수정 완료">
			</form>
		</div>
    </section>
    <!--================Contact Area =================-->
